...
**Model Accuracy on the `validation` set = `r round(100 * caret::confusionMatrix(validation$classe, predRF)$overall["Accuracy"],2)`%**
...
**Model Accuracy on `validation` set = `r round(100 * caret::confusionMatrix(validation$classe, predRFPC)$overall["Accuracy"],2)`%**
...
**Model Accuracy on `validation` set = `r round(100*caret::confusionMatrix(validation$classe, predSVMCV)$overall["Accuracy"],2)`%**
...
**Model Accuracy on the `validation` set = `r round(100*caret::confusionMatrix(validation$classe, predGBMCV)$overall["Accuracy"],2)`%**
...
**Model Accuracy on the `validation` set = `r round(100*caret::confusionMatrix(validation$classe, combined_pred)$overall["Accuracy"],2)`%** 
...
1. Random Forest, `modRF` = `r round(100 * caret::confusionMatrix(validation$classe, predRF)$overall["Accuracy"],2)`%

2. Random Forest with PCA, `modRFPCA` = `r round(100*caret::confusionMatrix(validation$classe, predRFPC)$overall["Accuracy"],2)`%

3. Linear SVM with Cross Validation, `modSVMCV` = `r round(100*caret::confusionMatrix(validation$classe, predSVMCV)$overall["Accuracy"],2)`%

4. GBM with Cross Validation, `modGBMCV` = `r round(100*caret::confusionMatrix(validation$classe, predGBMCV)$overall["Accuracy"],2)`%

5. Stacking models 1-4 with Random Forest, `combined_model` = `r round(100*caret::confusionMatrix(validation$classe, combined_pred)$overall["Accuracy"],2)`%
...
**So our estimated out of sample accuracy is `r round(100 * caret::confusionMatrix(final_validation$classe, finValCombinedPred)$overall["Accuracy"],2)`%.** 

## 6. Conclusion

In this report, we preprocessed the data and trained multiple models on the data. Then we selected the best model which was a stacked model containing all the other models based on the accuracy on the `validation` set. Finally we tested our model on the `final_validation` set to estimate the out of sample accuracy at `r round(100 * caret::confusionMatrix(final_validation$classe, finValCombinedPred)$overall["Accuracy"],2)`%.